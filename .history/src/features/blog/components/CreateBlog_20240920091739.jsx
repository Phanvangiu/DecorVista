...
export default function CreateBlog() {
  ...
  const handleSubmit = () => {
    ...
    formData.append("images", file.name); // Append tệp hình ảnh
    ...
    <div>
      ...
      <div>
        ...
        <label htmlFor="images" style={{ cursor: "pointer" }}>
          <img
            src="https://www.bing.com/ck/a?!&&p=29695dd40a6dab86JmltdHM9MTcyNjcwNDAwMCZpZ3VpZD0zMzhmYzYwYy1kNjE4LTZmZjYtM2U4Zi1kNGE1ZDcxODZlNDcmaW5zaWQ9NTUzNg&ptn=3&ver=2&hsh=3&fclid=338fc60c-d618-6ff6-3e8f-d4a5d7186e47&u=a1L2ltYWdlcy9zZWFyY2g_cT1pY29uJTIwdXBsb2FkJTIwJUUxJUJBJUEzbmgmRk9STT1JUUZSQkEmaWQ9M0NCMTQ3NjlFNDg5NDhBNThFOTI1MDE4RDFDQjE2QzM5QjUyOTZENw&ntb=1" // Example icon URL
            alt="Upload Icon"
